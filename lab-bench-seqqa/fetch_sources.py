...
def sources():
    ...
    base = 'https://raw.githubusercontent.com/Future-House/LAB-Bench/' + provenance['sha'] + '/'
    return [(name, base + name, digest) for name, digest in provenance['files_sha256'].items()]
